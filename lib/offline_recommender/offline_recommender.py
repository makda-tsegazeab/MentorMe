...
#       Example: learner_max=200, tutor_min=210 → small penalty
#                learner_max=200, tutor_min=300 → big penalty
#     """
...
#         if not completed:
#             continue  # 🔴 skip incomplete profiles completely
...
#         print(f"  → wrote {len(scored_items)} recommendations to recommendations/{lid}")
...
#         print(f"  → wrote {len(scored_learners)} learners to tutor_recommendations/{tid}")
